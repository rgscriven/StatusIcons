...
class StatusIcons {
		...
		class controls
		{
			...
			{
				idc=13371;
				x = 0.94 * safezoneW + safezoneX; 							//safeZoneX;             x = 0.95 * safezoneW + safezoneX;
				y = 0.31 * safezoneH + safezoneY;							//1 / 2 - 0.15;          y = 0.4 * safezoneH + safezoneY;       y = 0.65 * safezoneH + safezoneY;
				...
				class controls
				{
					...
					class HealthLabel: HealthIcon {
						...
						style = 2;
						sizeEx="20 * pixelH";
						text = "Addons\StatusIcons\icons\health.paa";
					};
					//////////////////////////////////////////////////////////////
					...
					class HungerLabel: HealthLabel {
						idc = 13383;
						y = 0.15;
						text = "Addons\StatusIcons\icons\hunger.paa";
					};
					//////////////////////////////////////////////////////////////
					...
					class ThirstLabel: HealthLabel {
						idc = 13384;
						y = 0.30;
						text = "Addons\StatusIcons\icons\thirst.paa";
					};
					//////////////////////////////////////////////////////////////
					...
					class ColdCircle: ColdIcon{
						idc = 13395;
						text="Addons\StatusIcons\circlebar\100.paa";
					};
					//////////////////////////////////////////////////////////////
				};
			};
